...
// The original HoloToolkit.Unity.UX.BoundingBox was modified for use in tandem with
// ModifiedBoundingBoxRig in AugmentedObservatory.
public class ModifiedBoundingBox : MonoBehaviour
{
    ...
    protected virtual void UpdateScaleTransform()
    {
        ...
        {
            case ModifiedBoundingBox.FlattenModeEnum.DoNotFlatten:
            default:
            ...
            case ModifiedBoundingBox.FlattenModeEnum.FlattenX:
                scale.x += (largestDimension * flattenedScalePadding);
                scale.y += (largestDimension * scalePadding);
                scale.z += (largestDimension * scalePadding);
                break;

            case ModifiedBoundingBox.FlattenModeEnum.FlattenY:
                scale.x += (largestDimension * scalePadding);
                scale.y += (largestDimension * flattenedScalePadding);
                scale.z += (largestDimension * scalePadding);
                break;

            case ModifiedBoundingBox.FlattenModeEnum.FlattenZ:
                scale.x += (largestDimension * scalePadding);
                scale.y += (largestDimension * scalePadding);
