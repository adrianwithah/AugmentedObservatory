...
// NonPersistSingleton, as its name suggests, is a Singleton which does not persist (live on)
// through scene transitions. This is useful for Singletons that are specific to a scene.
public class NonPersistSingleton<T> : MonoBehaviour where T : NonPersistSingleton<T>
{
