...
// The original HoloToolkit.Unity.UX.BoundingBoxGizmoHandle was modified for use in tandem with
// ModifiedBoundingBoxRig in AugmentedObservatory.
public class ModifiedBoundingBoxGizmoHandle : MonoBehaviour, IInputHandler, ISourceStateHandler
{
    private ModifiedBoundingBoxRig rig;
    ...
    public ModifiedBoundingBoxRig Rig
    {
        get
        {
            return rig;
